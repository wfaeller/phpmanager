    ...
    public sealed class PHPConfigHelper
    {
        ...
        private void ValidateLifecycle(PHPConfigInfo info)
        {
            var knownPhpVersions = new Dictionary<string, PhpVersion>
            {
                ...
                { "8.1", new PhpVersion("8.1", new DateTime(2025, 12, 31), new Version(14, 21)) },
                { "8.2", new PhpVersion("8.2", new DateTime(2026, 12, 31), new Version(14, 21)) },
                { "8.3", new PhpVersion("8.3", new DateTime(2027, 12, 31), new Version(14, 21)) },
            };
